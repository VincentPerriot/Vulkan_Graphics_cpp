...
// This is almost exactly the learn openGL class, nothing interesting
// TODO Update camera movement with Quaternion based rotation to avoid Gimbal Lock
// Currently just an if forbidding 90 degree pitch
